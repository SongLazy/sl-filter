...
cs.pop()
_(o4B,a6B)
cs.push("./pages/apposition/index.wxml:view:1:334")
var t7B=_n('view')
_rz(z,t7B,'class',11,e,s,gg)
cs.push("./pages/apposition/index.wxml:text:1:353")
var e8B=_n('text')
...
var oBC=_mz(z,'sl-filter',['bind:result',2,'color',1,'data-event-opts',2,'independence',3,'menuList',4,'themeColor',5],[],e,s,gg)
cs.pop()
_(xAC,oBC)
cs.push("./pages/independence/index.wxml:view:1:227")
var fCC=_n('view')
_rz(z,fCC,'style',8,e,s,gg)
cs.pop()
_(xAC,fCC)
