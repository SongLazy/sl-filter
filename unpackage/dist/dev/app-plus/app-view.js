...
Z([[7],[3,'themeColor']])
Z(z[7])
Z([3,'width:100%;background-color:#0077AA;height:100px;'])
Z([3,'占位view'])
Z(z[2])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[1,'changeMenuList']]]]]]]]])
Z([3,'margin-top:10px;width:90%;'])
Z([3,'primary'])
Z([3,'动态修改menuList的item'])
Z(z[2])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[1,'changeMenuListDetailList']]]]]]]]])
Z(z[16])
Z(z[17])
Z([3,'动态修改menuList的detailList'])
Z([3,'text'])
Z([a,[[7],[3,'filterResult']]])
...
Z([3,'__e'])
Z([3,'demo-cell-t'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[1,'toApposition']]]]]]]]])
Z([3,'并列菜单'])
Z([3,'demo-cell-b'])
Z([3,'并列菜单：筛选菜单各个子菜单选择完毕点击确定后回传所有结果'])
Z(z[3])
Z(z[4])
Z(z[5])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[1,'toIndependence']]]]]]]]])
Z([3,'独立菜单'])
Z(z[8])
Z([3,'独立菜单：设置插件属性 :independence\x3d\x22true\x22。筛选菜单每个子菜单选择完毕点击确定回传当前菜单结果'])
...
cs.push("./components/sl-filter/filter-view.wxml:view:1:233")
var tM=_n('view')
cs.push("./components/sl-filter/filter-view.wxml:view:1:239")
var eN=_n('view')
_rz(z,eN,'class',9,hG,cF,gg)
var bO=_v()
_(eN,bO)
cs.push("./components/sl-filter/filter-view.wxml:block:1:273")
var oP=function(oR,xQ,fS,gg){
cs.push("./components/sl-filter/filter-view.wxml:block:1:273")
cs.push("./components/sl-filter/filter-view.wxml:view:1:367")
var hU=_mz(z,'view',['bindtap',14,'class',1,'data-event-opts',2,'style',3],[],oR,xQ,gg)
cs.push("./components/sl-filter/filter-view.wxml:text:1:675")
var oV=_n('text')
var cW=_oz(z,18,oR,xQ,gg)
_(oV,cW)
cs.pop()
_(hU,oV)
cs.pop()
...
bO.wxXCkey=2
_2z(z,12,oP,hG,cF,gg,bO,'detailItem','idx','idx')
cs.pop()
cs.pop()
_(tM,eN)
cs.pop()
...
cs.push("./components/sl-filter/filter-view.wxml:view:1:760")
var oX=_n('view')
var lY=_v()
_(oX,lY)
if(_oz(z,19,hG,cF,gg)){lY.wxVkey=1
cs.push("./components/sl-filter/filter-view.wxml:block:1:766")
cs.push("./components/sl-filter/filter-view.wxml:view:1:827")
var aZ=_n('view')
_rz(z,aZ,'class',20,hG,cF,gg)
cs.push("./components/sl-filter/filter-view.wxml:text:1:862")
var t1=_n('text')
var e2=_oz(z,21,hG,cF,gg)
_(t1,e2)
cs.pop()
_(aZ,t1)
cs.pop()
...
cs.push("./components/sl-filter/filter-view.wxml:view:1:910")
var b3=_n('view')
_rz(z,b3,'class',22,hG,cF,gg)
var o4=_v()
_(b3,o4)
cs.push("./components/sl-filter/filter-view.wxml:block:1:946")
var x5=function(f7,o6,c8,gg){
cs.push("./components/sl-filter/filter-view.wxml:block:1:946")
cs.push("./components/sl-filter/filter-view.wxml:text:1:1040")
var o0=_mz(z,'text',['bindtap',27,'class',1,'data-event-opts',2,'style',3],[],f7,o6,gg)
var cAB=_oz(z,31,f7,o6,gg)
_(o0,cAB)
cs.pop()
_(c8,o0)
cs.pop()
...
o4.wxXCkey=2
_2z(z,25,x5,hG,cF,gg,o4,'detailItem','idx','idx')
cs.pop()
cs.pop()
_(oX,b3)
cs.push("./components/sl-filter/filter-view.wxml:view:1:1445")
var oBB=_n('view')
_rz(z,oBB,'class',32,hG,cF,gg)
cs.push("./components/sl-filter/filter-view.wxml:view:1:1481")
var lCB=_mz(z,'view',['bindtap',33,'class',1,'data-event-opts',2,'style',3],[],hG,cF,gg)
cs.push("./components/sl-filter/filter-view.wxml:text:1:1696")
var aDB=_n('text')
var tEB=_oz(z,37,hG,cF,gg)
_(aDB,tEB)
cs.pop()
_(lCB,aDB)
cs.pop()
_(oBB,lCB)
cs.push("./components/sl-filter/filter-view.wxml:view:1:1722")
var eFB=_mz(z,'view',['bindtap',38,'class',1,'data-event-opts',2,'style',3],[],hG,cF,gg)
cs.push("./components/sl-filter/filter-view.wxml:text:1:1912")
var bGB=_n('text')
var oHB=_oz(z,42,hG,cF,gg)
_(bGB,oHB)
cs.pop()
_(eFB,bGB)
cs.pop()
...
var oJB=_mz(z,'scroll-view',['scrollY',-1,'bind:__l',0,'bindtap',1,'catchtouchmove',1,'class',2,'data-event-opts',3,'hidden',4],[],e,s,gg)
cs.push("./components/sl-filter/popup-layer.wxml:view:1:207")
var fKB=_mz(z,'view',['catchtap',6,'class',1,'data-event-opts',2,'data-ref',3,'style',4],[],e,s,gg)
...
var cOB=_n('view')
_rz(z,cOB,'style',2,e,s,gg)
cs.push("./components/sl-filter/sl-filter.wxml:view:1:89")
var oPB=_mz(z,'view',['class',3,'style',1],[],e,s,gg)
var lQB=_v()
_(oPB,lQB)
cs.push("./components/sl-filter/sl-filter.wxml:block:1:197")
var aRB=function(eTB,tSB,bUB,gg){
cs.push("./components/sl-filter/sl-filter.wxml:block:1:197")
cs.push("./components/sl-filter/sl-filter.wxml:view:1:282")
var xWB=_mz(z,'view',['bindtap',9,'class',1,'data-event-opts',2,'style',3],[],eTB,tSB,gg)
cs.push("./components/sl-filter/sl-filter.wxml:text:1:423")
var oXB=_n('text')
_rz(z,oXB,'style',13,eTB,tSB,gg)
var fYB=_oz(z,14,eTB,tSB,gg)
_(oXB,fYB)
cs.pop()
_(xWB,oXB)
cs.push("./components/sl-filter/sl-filter.wxml:text:1:483")
var cZB=_n('text')
...
var h1B=_mz(z,'popup-layer',['bind:close',16,'class',1,'data-event-opts',2,'data-ref',3,'direction',4,'isTransNav',5,'navHeight',6,'tabHeight',7,'vueSlots',8],[],e,s,gg)
cs.push("./components/sl-filter/sl-filter.wxml:sl-filter-view:1:831")
var o2B=_mz(z,'sl-filter-view',['bind:confirm',25,'class',1,'data-event-opts',2,'data-ref',3,'independence',4,'menuList',5,'themeColor',6],[],e,s,gg)
cs.pop()
_(h1B,o2B)
cs.pop()
_(oNB,h1B)
...
var l5B=_mz(z,'sl-filter',['bind:result',2,'class',1,'color',2,'data-event-opts',3,'data-ref',4,'isTransNav',5,'menuList',6,'navHeight',7,'themeColor',8,'topFixed',9],[],e,s,gg)
cs.pop()
_(o4B,l5B)
cs.push("./pages/apposition/index.wxml:view:1:299")
var a6B=_n('view')
_rz(z,a6B,'style',12,e,s,gg)
cs.push("./pages/apposition/index.wxml:text:1:363")
var t7B=_n('text')
...
cs.pop()
_(o4B,a6B)
cs.push("./pages/apposition/index.wxml:button:1:393")
var b9B=_mz(z,'button',['bindtap',14,'data-event-opts',1,'style',2,'type',3],[],e,s,gg)
var o0B=_oz(z,18,e,s,gg)
_(b9B,o0B)
cs.pop()
_(o4B,b9B)
cs.push("./pages/apposition/index.wxml:button:1:554")
var xAC=_mz(z,'button',['bindtap',19,'data-event-opts',1,'style',2,'type',3],[],e,s,gg)
var oBC=_oz(z,23,e,s,gg)
_(xAC,oBC)
cs.pop()
_(o4B,xAC)
cs.push("./pages/apposition/index.wxml:view:1:731")
var fCC=_n('view')
_rz(z,fCC,'class',24,e,s,gg)
cs.push("./pages/apposition/index.wxml:text:1:750")
var cDC=_n('text')
...
var oHC=_mz(z,'sl-filter',['bind:result',2,'color',1,'data-event-opts',2,'independence',3,'menuList',4,'themeColor',5],[],e,s,gg)
cs.pop()
_(cGC,oHC)
cs.push("./pages/independence/index.wxml:view:1:227")
var lIC=_n('view')
_rz(z,lIC,'style',8,e,s,gg)
cs.pop()
_(cGC,lIC)
cs.push("./pages/independence/index.wxml:view:1:298")
var aJC=_n('view')
_rz(z,aJC,'class',9,e,s,gg)
cs.push("./pages/independence/index.wxml:text:1:317")
var tKC=_n('text')
...
cs.push("./pages/index/index.wxml:view:1:65")
var oPC=_n('view')
_rz(z,oPC,'class',3,e,s,gg)
cs.push("./pages/index/index.wxml:view:1:89")
var fQC=_mz(z,'view',['bindtap',4,'class',1,'data-event-opts',2],[],e,s,gg)
cs.push("./pages/index/index.wxml:text:1:180")
var cRC=_n('text')
...
cs.pop()
_(oPC,fQC)
cs.push("./pages/index/index.wxml:view:1:212")
var oTC=_n('view')
_rz(z,oTC,'class',8,e,s,gg)
cs.push("./pages/index/index.wxml:text:1:238")
var cUC=_n('text')
...
cs.push("./pages/index/index.wxml:view:1:376")
var aXC=_mz(z,'view',['bindtap',11,'class',1,'data-event-opts',2],[],e,s,gg)
cs.push("./pages/index/index.wxml:text:1:469")
var tYC=_n('text')
...
cs.push("./pages/index/index.wxml:text:1:527")
var o2C=_n('text')
